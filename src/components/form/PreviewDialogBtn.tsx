...
const PreviewDialogBtn = () => {
  ...
  Form preview
        ...
        <div className="bg-accent flex flex-col flex-grow items-center justify-center p-4 bg-[url(/jupiter.svg)] dark:bg-[url(/jupiter-dark.svg)] overflow-y-auto">
