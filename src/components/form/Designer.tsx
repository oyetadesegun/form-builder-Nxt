"use client"
import { useDroppable, DragEndEvent, useDndMonitor, useDraggable } from "@dnd-kit/core";
...
export default function Designer() {
    ...
    useDndMonitor({
        onDragEnd: (event: DragEndEvent) => {
            ...
            // First scenario: dropping btn element over the designer drop area
            ...
            const draggingDesignerElementOverAnotherDesignElement = isDroppingOverDesignerElement && isDraggingDesignerElement;
            if (draggingDesignerElementOverAnotherDesignElement){
